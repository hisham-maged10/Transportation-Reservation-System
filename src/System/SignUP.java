...
public class SignUP extends FileHandling{
	...
	private void initialize() {
		...
		frame.getContentPane().add(BG, "name_3904661425596");
		BG.setLayout(null);
		
		JPanel Info = new JPanel();
		Info.setBounds(392, 0, 544, 642);
		Info.setBackground(new Color(40, 163, 163).darker().darker());
		BG.add(Info);
		Info.setLayout(null);
		...
		lblNewLabel.setBounds(67, 85, 132, 36);
		...
		textField.setBackground(new Color(40, 163, 163).darker().darker());
		...
		lblLastname.setBounds(67, 175, 132, 36);
		...
		textField_1.setBackground(new Color(19, 79, 79));
		...
		textField_2.setBackground(new Color(19, 79, 79));
		...
		txtExample_1.setBackground(new Color(19, 79, 79));
		...
		txtExample.setBackground(new Color(19, 79, 79));
		...
		btnSignUp = new JButton("Get Started");
		...
		btnSignUp.setBackground(new Color(19,79,79).brighter());
		btnSignUp.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				playsound(Text);
				btnSignUp.setBackground(new Color(19,79,79).darker());
			}
		...
		agreement.setBackground(new Color(19,79,79));
		...
		JLabel lblAlreadyAMember = new JLabel("Already a Member? Login now!");
		...
		btnNewButton.setBackground(new Color(19,79,79));
		btnNewButton.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				playsound(Text);
				btnNewButton.setBackground(new Color(19,79,79).darker());
			}
			public void mouseExited(MouseEvent e) {
				playsound(Text);
				btnNewButton.setBackground(new Color(19,79,79));
		...
		Design.setBackground(new Color(40, 163, 163).darker());
		BG.add(Design);
		...
		lblNewLabel_3.setBounds(0, 440, 395, 166);
		Design.add(lblNewLabel_3);
		
		JLabel lblWantToJoin = new JLabel("Want to Join our Crew? Click Here!");
		lblWantToJoin.setForeground(SystemColor.menu);
		lblWantToJoin.setBounds(172, 607, 211, 35);
		lblWantToJoin.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				playsound(Text);
				lblWantToJoin.setForeground(Color.black);
			}
			public void mouseExited(MouseEvent e) {
				playsound(Text);
				lblWantToJoin.setForeground(SystemColor.control);
			}
			public void mouseClicked(MouseEvent e) {
				playsound(Press);
				...
				time.schedule(new TimerTask() {
							public void run() {
								playsound(Bam);
								DriverSignUp driver=new DriverSignUp();
		...
		button.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				playsound(Text);
				button.setBackground(new Color(40, 163, 163).darker().darker());
			}
			public void mouseExited(MouseEvent e) {
				playsound(Text);
		...
		loading = new JPanel();
		frame.getContentPane().add(loading, "name_3904670719180");
		loading.setLayout(null);
		
		JLabel lblNewLabel_4 = new JLabel();
		lblNewLabel_4.setIcon(new ImageIcon("src/System/images/31.gif"));
...
//search/edit/add booking/delete/edit
